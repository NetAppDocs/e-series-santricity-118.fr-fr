...
. Allez à <<Étape 2 : affecter un volume de snapshot à l'hôte>>.
...
+
** Si le volume de votre snapshot est en lecture/écriture, la boîte de dialogue capacité de révision s'affiche. Allez à <<Étape 3 : réserver de la capacité pour un volume Snapshot>>.
** Si votre volume de snapshot est en lecture seule, la boîte de dialogue Modifier la priorité s'affiche. Allez à <<Étape 4 : modifiez les paramètres d'un volume de snapshot>>.
...
. Cliquez sur *Suivant*, puis allez à <<Étape 4 : modifiez les paramètres d'un volume de snapshot>>.
