...
** *Ajout manuel*
+
Si aucun identificateur de port d'hôte n'est affiché dans la liste, cela signifie que le port d'hôte n'est pas connecté. Un utilitaire HBA ou l'utilitaire iSCSI initiator peut être utilisé pour trouver les identificateurs de port d'hôte et les associer à l'hôte.
