...
. Cliquez sur *Suivant*, puis allez à <<Étape 2 : réserver de la capacité du groupe de cohérence Snapshot>>.
...
. Cliquez sur *Suivant*, puis allez à <<Étape 3 : modifiez les paramètres du groupe de cohérence des snapshots>>.
